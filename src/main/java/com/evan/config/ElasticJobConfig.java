...
import com.evan.job.MyDataFlowJob;
import com.evan.job.MySimpleJob;
...
public class ElasticJobConfig {
    ...
    public JobScheduler simpleJobScheduler(final MySimpleJob simpleJob,
                                           @Value("${evanJob.cron}") final String cron,
                                           @Value("${evanJob.shardingTotalCount}") final int shardingTotalCount,
                                           @Value("${evanJob.shardingItemParameters}") final String shardingItemParameters,
                                           @Value("${evanJob.jobParameter}") final String jobParameter) {
    ...
    public JobScheduler dataFlowJobScheduler(final MyDataFlowJob dataFlowJob,
                                             @Value("${evanJob.dataflow.cron}") final String cron,
                                             @Value("${evanJob.dataflow.shardingTotalCount}") final int shardingTotalCount,
                                             @Value("${evanJob.dataflow.shardingItemParameters}") final String shardingItemParameters ) {
